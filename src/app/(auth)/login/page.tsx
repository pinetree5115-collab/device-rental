...
import { useAuth } from "@/hooks/useAuth_copy";
...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 로그인 성공 시 useAuth 훅에서 자동으로 페이지 이동
        } catch (err) {
            // 에러는 useAuth에서 처리됨
    ...
    return (
        <main className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md shadow-lg p-8 relative">
                {/* 닫기 버튼 */}
                <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="button"
                        className="w-full border border-gray-300 bg-white text-gray-700 py-3 font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                    >
