...
import { getPointHistoryApi } from "@/services/point.service";
...
function PointsPage({ onBack }: PointsPageProps) {
    ...
    const { data } = useQuery({
        ...
        queryFn: getPointHistoryApi,
        enabled: !!user, // user 데이터가 있을 때만 포인트 이력 조회
    });

    const currentBalance = data?.[0]?.finalBalance || 0;
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-gray-500">
                                                    잔액:{" "}
                                                    {history.finalBalance.toLocaleString()}
                                                    P
                                                </p>
                                            </div>
                    ...
                    <div className="mt-8 p-6 bg-blue-50 border border-blue-200">
                        ...
                        <ul className="space-y-2 text-sm text-gray-700">
                            ...
                            <li>
                                • 대여 취소 시 사용한 포인트는 즉시 환원됩니다.
                            </li>
                            <li>
                                • 포인트는 타인에게 양도하거나 현금으로 환급할
                                수 없습니다.
                            </li>
                        </ul>
                    </div>
