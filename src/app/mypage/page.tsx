                ...
                <div key={section.id} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-1">
                    {section.items.map((item) => {
                      const isActive = item.id === 'my-profile';
          ...
          <main className="flex-1">
            ...
            <div className="grid grid-cols-3 gap-6 mt-6">
              ...
              <div className="bg-white border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-600 mb-1">등록한 물품</p>
                <p className="text-3xl font-bold text-gray-900">{statistics.registeredItems}</p>
              </div>
              ...
              <div className="bg-white border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-600 mb-1">진행 중 대여</p>
                <p className="text-3xl font-bold text-gray-900">{statistics.activeRentals}</p>
              </div>
